...
from utils.sv_trials_loaders import dataloader_from_trial, get_spk2xvector, generate_scores_from_net, \
    ...
    dataset_from_sre08_10_trial, load_xvec_from_batch, generate_scores_from_plda, valid_trials_wrapper, train_kaldi_plda
...
def main_kaldiplda():
    ...
    logging.info("Started at {}\n\n softCdet Loss. Kaldi init. Batch size = 4096. Alpha = 5  Threshold1 and Threshold2 fixed using SRE 2018 dev after kaldi init. \n\n".format(
    ...
    data_dir_list = np.asarray([['/home/data2/SRE2019/prashantk/voxceleb/v1/data/train_16k/male', '2'],
                                ['/home/data2/SRE2019/prashantk/voxceleb/v1/data/train_16k/female', '2']])

    xvector_scp_list = np.asarray(
        ['/home/data2/SRE2019/prashantk/voxceleb/v1/exp/xvector_nnet_1a/xvectors_train_16k_combined/xvector_fullpaths.scp',
         '/home/data2/SRE2019/prashantk/voxceleb/v1/exp/xvector_nnet_1a/xvectors_voices_dev_enrollment_copy/xvector_fullpaths.scp',
         '/home/data2/SRE2019/prashantk/voxceleb/v1/exp/xvector_nnet_1a/xvectors_voices_dev_test_copy/xvector_fullpaths.scp',
         '/home/data2/SRE2019/prashantk/voxceleb/v1/exp/xvector_nnet_1a/xvectors_voices_eval_enrollment/xvector_fullpaths.scp',
         '/home/data2/SRE2019/prashantk/voxceleb/v1/exp/xvector_nnet_1a/xvectors_voices_eval_test/xvector_fullpaths.scp'])


    xvec_dict = get_train_dataset(data_dir_list, xvector_scp_list, id_to_num_dict, batch_size=4096, train_and_valid=True, train_ratio=0.95) # train_set, val_set
    ...
    pickle.dump(mega_xvec_dict, open('pickled_files/mega_xvec_dict_voxceleb_with_aug_and_voices.pkl','wb'))
    print("DONE")
    exit()

    
    combined_dataset_valid = torch.utils.data.ConcatDataset(datasets_valid)
    combined_dataset_train = torch.utils.data.ConcatDataset(datasets_train)
    train_kaldi_plda(combined_dataset_train, num_to_id_dict, mega_xvec_dict)
